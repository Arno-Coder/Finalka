...
document.getElementById("RegistrationBtn")
  .addEventListener("click", () => {
    const clientTypeSelected = document.getElementById("clientType").value;
    const agreementChecked = document.getElementById("agreementCheckbox").checked;
    
    if (!agreementChecked || clientTypeSelected === "") {
      alert("Please choose a client type and agree with our terms.");
      return;
    }
  ...
  clientTypeDropdown.addEventListener('change', (event) => {
